...
sample.name = 'GAP500-3_Pre';
sample.area = '0.00196';  % mm^2
sample.comment = 'Stage 3 25s 1.0MHz 125mV 4rej';
...
temp_init = 95;           % K, Initial DLTS temperature
temp_step = 1;           % K, Capture transient each temp5 step
